...
public class VehicleService {
    ...
    public List filterVehicles(Map<String, Object> paramMap, List<String> whereClause) {
    ...
    public List filterVehiclesByWord(Map<String, Object> paramMap, List<String> whereClause) {
        StringBuilder queryBuilder = new StringBuilder("select v from Vehicle v ");
